    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          ...
          {/* Success Header with Animated Pattern */}
          ...
          <div className="md:p-6 p-4 text-center">
            <div className="mb-4">
              ...
              <div className="inline-block">
                <div className="relative bg-linear-to-r from-pink-100 via-purple-100 to-pink-100 md:px-6 px-4 md:py-3 py-2 rounded-xl border-2 border-pink-200 shadow-lg transform hover:scale-105 transition-transform overflow-hidden">
                  {/* Shimmer overlay */}
                  <div
                  ...
                  />
                  <p className="text-xl sm:text-2xl md:text-3xl font-bold bg-linear-to-r from-pink-600 via-purple-600 to-pink-600 bg-clip-text text-transparent relative z-10">
                    {result}
                  </p>
                </div>
              </div>
